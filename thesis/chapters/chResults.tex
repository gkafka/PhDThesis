...
As mentioned at the end of section \ref{sec:ResultsND}, the value of $\delta_{24}$ was held fixed. The FC corrected curves were calculated using values of $\delta_{24} = 0$, $\pi/2$, and $3\pi/2$. The most conservative results were obtained from $\delta_{24} = \pi/2$, so this value was used for the final measurements.
...
\begin{figure}[htbp]
  \centering
  \begin{tabular}{c c}
    \includegraphics[width=.47\textwidth]{figures/Fits/cFCSigD241Pi2.png} &
    \includegraphics[width=.47\textwidth]{figures/Fits/2D3424FCD241Pi2.png} \\
  \end{tabular}
...
\begin{figure}[htbp]
  \centering
  \begin{tabular}{c c}
    \includegraphics[width=.47\textwidth]{figures/Fits/1DTh34FCD241Pi2.png} &
    \includegraphics[width=.47\textwidth]{figures/Fits/1DTh24FCD241Pi2.png} \\
  \end{tabular}
