...
\begin{figure}[htbp]
  \centering
  \begin{tabular}{c c}
    \includegraphics[width=.48\textwidth]{figures/NDDataMC/VtxXNusNDRat.png} &
    \includegraphics[width=.48\textwidth]{figures/NDDataMC/VtxYNusNDRat.png} \\
    \includegraphics[width=.48\textwidth]{figures/NDDataMC/VtxZNusNDRat.png} &
    \includegraphics[width=.48\textwidth]{figures/NDDataMC/ContNusNDRat.png} \\
  \end{tabular}
