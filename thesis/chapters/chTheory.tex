...
\beq
i \begin{pmatrix} \nue \\ \numu \end{pmatrix} = \left[ U \begin{pmatrix} \frac{m^2_1}{2E} & 0 \\ 0 & \frac{m^2_2}{2E} \end{pmatrix} U^* + \begin{pmatrix} V_e & 0 \\ 0 & 0 \end{pmatrix} \right] \begin{pmatrix} \nue \\ \numu \end{pmatrix}
\label{eq:2NuSchro}
\eeq
